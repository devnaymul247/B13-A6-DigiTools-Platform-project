            ...
            <div className='lg:flex justify-between items-center gap-14'>
                ...
                <div className='space-y-4'>
                    ...
                    <div className='flex gap-4 my-8 lg:my-2.5'>
                        ...
                        <button className="btn bg-transparent border border-[#4F39F6] text-[#4F39F6] rounded-full hover:bg-linear-to-r hover:from-[#4F39F6] hover:to-[#9514FA] hover:text-white">
